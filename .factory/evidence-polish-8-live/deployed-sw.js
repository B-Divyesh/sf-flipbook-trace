const VERSION = 'flipbook-trace-v1.0.19-6941973fa6d2';
const SHELL = `${VERSION}-shell`;
const RUNTIME = `${VERSION}-runtime`;
const PRECACHE = [
  '/', '/demo', '/privacy', '/terms', '/offline.html', '/manifest.webmanifest',
  '/favicon.svg', '/assets/index-BGaqZF94.js', '/assets/index-g92mjG77.css', '/assets/app-BEAnAZ6s.js', '/assets/core-nBFmSFRJ.js', '/assets/demo-BDcWYL2k.js', '/assets/demo-runtime-DmUibRKO.js', '/assets/frame-processor-B3kBjuqS.js', '/assets/static-pages-L-BwBuiE.js',
